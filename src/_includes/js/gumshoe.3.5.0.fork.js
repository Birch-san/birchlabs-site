(function (root, factory) {
	...
	var defaults = {
		...
		activateAlso: function(navLink) {
			return navLink.classList.contains('dropdown-item')
			&& navLink.parentNode
			&& navLink.parentNode.parentNode
			&& navLink.parentNode.parentNode.firstChild
			&& navLink.parentNode.parentNode.parentNode.firstChild;
		}
	};
